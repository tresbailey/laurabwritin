...
function showContactErrorToast() {
  const toast = document.getElementById('contact-error');
    toast.classList.remove('hidden');
...
const sendContactEmail = async (e) => {
    ...
    try {
            ...
            const response = await fetch('https://if2rk6vu3jd4zqqk73q35zqx7y0lvrrv.lambda-url.us-east-1.on.aws/contact', {
                method: 'POST',
